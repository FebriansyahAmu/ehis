...
| **Katalog BMHP/BHP** | `/ehis-master/katalog-bmhp` | (akan dibuat) `bmhpMock.ts` + `bmhpSeed.ts` | 📋 Planned — **terpisah dari Obat**, meniru pola Obat. Workflow → [BACKEND-MASTER-KATALOG-BMHP.md](BACKEND-MASTER-KATALOG-BMHP.md) |
