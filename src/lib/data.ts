  ...
  "ri-1": {
    ...
    resepRI: {
      items: [
        ...
        { id: "rx-ri1-3", namaObat: "Furosemide 40mg Inj", kodeObat: "FAR-012", dosis: "40 mg",  signa: "2×1",    jumlah: 14, rute: "IV Bolus", aturanPakai: "Terlepas dari Makan",kategori: "Reguler",  keterangan: "IV bolus perlahan q12h, pantau balance & diuresis", durasiHari: 7,  tanggalOrder: "2025-05-03", dokterPj: "dr. Dewi Kusuma, Sp.JP", aktif: true  },
        ...
        { id: "rx-ri1-6", namaObat: "Heparin 5000 IU",     kodeObat: "FAR-H06", dosis: "5000 IU",signa: "2×1",    jumlah: 14, rute: "SC",       aturanPakai: "Terlepas dari Makan", kategori: "Reguler",  keterangan: "Profilaksis DVT q12h, rotasi area injeksi abdomen", durasiHari: 7,  tanggalOrder: "2025-05-03", dokterPj: "dr. Dewi Kusuma, Sp.JP", aktif: true  },
        { id: "rx-ri1-7", namaObat: "KSR 600mg",           kodeObat: "FAR-K07", dosis: "600 mg", signa: "3×1",    jumlah: 21, rute: "Oral",     aturanPakai: "PC (Sesudah Makan)", kategori: "Reguler",  keterangan: "Suplemen kalium — monitor kadar K+ serum, stop jika K+ >5 mEq/L", durasiHari: 7,  tanggalOrder: "2025-05-03", dokterPj: "dr. Dewi Kusuma, Sp.JP", aktif: true  },
      ],
      mar: [
...
// Mock worklist Rawat Jalan (rjPatients + rjStats) DIHAPUS — worklist RJ kini DB-driven
// (GET /kunjungan, statistik diturunkan di RJPageView). Detail rekam demo (rj-1…) tetap di
// `rawatJalanPatientDetails` di bawah (fallback halaman rekam untuk pasien non-UUID).
