...
export interface ObatSeedRecord extends ObatRecord {
...
export const OBAT_SEED: ObatSeedRecord[] = [
  ...
  { id: "obt-003", kode: "J01FA10", namaGenerik: "Azithromycin", namaDagang: "Zithromax", pabrik: "Pfizer", kategori: "Antibiotik", bentuk: "Tablet", kekuatan: "500 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 18500, kodeFornas: "J01FA10", bpjsCoverage: true, status: "Aktif", kfaCode: "936220030" },
  { id: "obt-004", kode: "J01MA02", namaGenerik: "Ciprofloxacin", namaDagang: "Ciproxin", pabrik: "Bayer", kategori: "Antibiotik", bentuk: "Tablet", kekuatan: "500 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 6500, kodeFornas: "J01MA02", bpjsCoverage: true, status: "Aktif", kfaCode: "936220040" },

  // ── Analgesik ──
  { id: "obt-010", kode: "N02BE01", namaGenerik: "Paracetamol", namaDagang: "Sanmol", pabrik: "Sanbe", kategori: "Analgesik", bentuk: "Tablet", kekuatan: "500 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Bebas", hargaSatuan: 850, het: 1200, kodeFornas: "N02BE01", bpjsCoverage: true, status: "Aktif", kfaCode: "936210001",
  ...
  { id: "obt-011", kode: "M01AE01", namaGenerik: "Ibuprofen", namaDagang: "Proris", pabrik: "Pharos", kategori: "Analgesik", bentuk: "Tablet", kekuatan: "400 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Bebas_Terbatas", hargaSatuan: 1200, kodeFornas: "M01AE01", bpjsCoverage: true, status: "Aktif", kfaCode: "936230010" },
  ...
  { id: "obt-013", kode: "N02AB03", namaGenerik: "Fentanil", namaDagang: "Durogesic", pabrik: "Janssen", kategori: "Analgesik", bentuk: "Injeksi", kekuatan: "50 mcg/ml", satuanTerkecil: "Ampul", rute: "IV", isFormularium: true, isHAM: true, golongan: "Narkotika_II", isRestricted: true, isLASA: true, lasaPairIds: ["obt-012"], hargaSatuan: 85000, kodeFornas: "N02AB03", bpjsCoverage: true, status: "Aktif" },

  // ── Antihipertensi ──
  { id: "obt-020", kode: "C09AA02", namaGenerik: "Captopril", namaDagang: "Capoten", pabrik: "Indofarma", kategori: "Antihipertensi", bentuk: "Tablet", kekuatan: "25 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 750, kodeFornas: "C09AA02", bpjsCoverage: true, status: "Aktif", kfaCode: "936240020" },
  ...
  { id: "obt-022", kode: "C08CA01", namaGenerik: "Amlodipine", namaDagang: "Norvask", pabrik: "Pfizer", kategori: "Antihipertensi", bentuk: "Tablet", kekuatan: "10 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 2100, kodeFornas: "C08CA01", bpjsCoverage: true, status: "Aktif", kfaCode: "936240010" },
  ...
  { id: "obt-033", kode: "C03CA01", namaGenerik: "Furosemide", namaDagang: "Lasix", pabrik: "Sanofi", kategori: "Kardiovaskular", bentuk: "Tablet", kekuatan: "40 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 950, kodeFornas: "C03CA01", bpjsCoverage: true, status: "Aktif", kfaCode: "936270020" },

  // ── Antidiabetik ──
  { id: "obt-040", kode: "A10BA02", namaGenerik: "Metformin", namaDagang: "Glucophage", pabrik: "Merck", kategori: "Antidiabetik", bentuk: "Tablet", kekuatan: "500 mg", satuanTerkecil: "Tablet", rute: "PO", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 1100, kodeFornas: "A10BA02", bpjsCoverage: true, status: "Aktif", kfaCode: "936250010" },
  ...
  { id: "obt-042", kode: "A10AE05", namaGenerik: "Insulin Glargine", namaDagang: "Lantus", pabrik: "Sanofi", kategori: "Antidiabetik", bentuk: "Injeksi", kekuatan: "100 IU/ml", satuanTerkecil: "Vial", rute: "SC", isFormularium: false, isHAM: true, isColdChain: true, isLASA: true, lasaPairIds: ["obt-041"], golongan: "Keras_G", hargaSatuan: 285000, bpjsCoverage: false, status: "Aktif" },

  // ── Saluran Cerna ──
  { id: "obt-050", kode: "A02BC01", namaGenerik: "Omeprazole", namaDagang: "Losec", pabrik: "AstraZeneca", kategori: "Saluran_Cerna", bentuk: "Kapsul", kekuatan: "20 mg", satuanTerkecil: "Kapsul", rute: "PO", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 1850, kodeFornas: "A02BC01", bpjsCoverage: true, status: "Aktif", kfaCode: "936260010" },
  ...
  { id: "obt-052", kode: "A04AA01", namaGenerik: "Ondansetron", namaDagang: "Zofran", pabrik: "Novartis", kategori: "Saluran_Cerna", bentuk: "Injeksi", kekuatan: "4 mg/2ml", satuanTerkecil: "Ampul", rute: "IV", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 9500, kodeFornas: "A04AA01", bpjsCoverage: true, status: "Aktif", kfaCode: "936260020" },

  // ── Saluran Nafas ──
  { id: "obt-060", kode: "R03AC02", namaGenerik: "Salbutamol", namaDagang: "Ventolin", pabrik: "GSK", kategori: "Saluran_Nafas", bentuk: "Inhaler", kekuatan: "100 mcg/dosis", satuanTerkecil: "Pcs", rute: "Inhalasi", isFormularium: true, isHAM: false, golongan: "Keras_G", hargaSatuan: 55000, kodeFornas: "R03AC02", bpjsCoverage: true, status: "Aktif", kfaCode: "936270010" },
  ...
  // ── Vitamin & Cairan ──
  { id: "obt-080", kode: "B05BB01", namaGenerik: "NaCl 0.9%", namaDagang: "Otsuka NaCl", pabrik: "Otsuka", kategori: "Vitamin_Cairan", bentuk: "Cairan", kekuatan: "500 ml", satuanTerkecil: "Botol", rute: "IV", isFormularium: true, isHAM: false, golongan: "Bebas", hargaSatuan: 15000, kodeFornas: "B05BB01", bpjsCoverage: true, status: "Aktif", kfaCode: "936280010" },
  { id: "obt-081", kode: "B05BA03", namaGenerik: "Ringer Laktat", namaDagang: "Otsuka RL", pabrik: "Otsuka", kategori: "Vitamin_Cairan", bentuk: "Cairan", kekuatan: "500 ml", satuanTerkecil: "Botol", rute: "IV", isFormularium: true, isHAM: false, golongan: "Bebas", hargaSatuan: 16500, kodeFornas: "B05BA03", bpjsCoverage: true, status: "Aktif", kfaCode: "936280011" },
