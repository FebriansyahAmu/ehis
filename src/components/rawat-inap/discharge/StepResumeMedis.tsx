        ...
        <div className="min-w-0 flex-1 space-y-3">
          ...
          <div className="flex items-center gap-3 rounded-xl border border-orange-200 bg-orange-50 px-4 py-2.5">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs font-semibold text-orange-800">Hari Pulang — Resume Medis & Finalisasi</p>
              <p className="text-[10px] text-orange-600">Diselesaikan saat hari kepulangan · Standar PMK 24/2022</p>
            </div>
          </div>
