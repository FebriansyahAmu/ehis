...
export default function TagihanHero({ timestamp }: Props) {
  return (
    <motion.header
      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-0.5 max-w-2xl text-[13px] text-slate-500 dark:text-slate-400">
            Pantau, telusuri, dan kelola tagihan lintas unit pelayanan — dari Draft sampai Klaim Selesai.
          </p>
        </div>

        {/* Right: timestamp pill + CTA */}
        <div className="flex items-center gap-2">
          <span
