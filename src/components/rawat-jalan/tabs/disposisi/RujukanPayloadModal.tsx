...
// Modal pratinjau payload Rujukan (JSON) — body wire V-Claim Rujukan/insert (t_rujukan) dari isian
// form Rujuk Eksternal JKN. Portal + Escape/backdrop tutup + tombol Salin. Pola identik
// RencanaKontrolPayloadModal / SepPayloadModal. noSep & user di-resolve SERVER saat pengiriman
...
export default function RujukanPayloadModal({
  payload,
  endpoint,
  onClose,
}: {
  payload: unknown;
  endpoint: string; // "Rujukan/insert" | "Rujukan/Update"
  onClose: () => void;
}) {
      ...
      >
        <div className="flex items-center justify-between gap-3 border-b border-slate-100 px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-[15px] font-bold text-slate-900">Payload Rujukan</h2>
              <p className="text-[11px] text-slate-400">
                Pratinjau body <span className="font-mono">request.t_rujukan</span> — V-Claim{" "}
