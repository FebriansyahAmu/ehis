    ...
    <div ref={ref} className="relative">
      <div className="relative">
        ...
        <input
          ...
          className={inputCls ?? "h-9 w-full rounded-xl border border-slate-200 bg-slate-50 pl-8 pr-3 text-xs text-slate-800 outline-none transition focus:border-indigo-400 focus:bg-white focus:ring-2 focus:ring-indigo-100"}
        />
      </div>
            ...
            >
              ...
              <div className="flex shrink-0 flex-col items-end gap-0.5">
                <div className="flex items-center gap-1">
                  {obat.isHAM && <span className={HAM_BADGE}>HAM</span>}
