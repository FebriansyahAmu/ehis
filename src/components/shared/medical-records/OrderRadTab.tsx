  ...
  "RI-2025-001": [
    {
      ...
      tanggal: "7 Mei 2026",
      jam: "08:15",
      dokter: "dr. Anisa Putri, Sp.JP",
      status: "Selesai",
      catatan: "Evaluasi kardiomegali — hari perawatan ke-3",
      items: [
        { id: "roi-ri-1", kode: "RAD-XR001", nama: "Foto Thorax PA", modalitas: "X-Ray", waktuTunggu: "30–60 mnt" },
      ],
    },
  ],
};
  ...
  "RI-2025-001": [
    {
      ...
      status: "Selesai",
      items: [
        { id: "rri-ri-1", kode: "RAD-XR001", nama: "Foto Thorax PA", modalitas: "X-Ray", waktuTunggu: "30–60 mnt" },
        { id: "rri-ri-2", kode: "RAD-US007", nama: "Echocardiografi", modalitas: "USG", waktuTunggu: "2–3 jam" },
      ],
      hasil: [
        {
          modalitas: "X-Ray",
          proyeksi: "PA",
          temuan:
            "Jantung: kardiomegali (CTR ± 0.62). Aorta: elongasi ringan. Kedua paru: infiltrat di zona bawah bilateral berkurang dibanding foto sebelumnya, masih tampak haziness di basis. Sinus kostofrenikus bilateral masih tumpul minimal. Diafragma: mendatar.",
          kesan:
            "Kardiomegali dengan perbaikan gambaran edema paru dibanding foto sebelumnya. Efusi pleura bilateral minimal, kesan residual.",
          radiolog: "dr. Purnomo, Sp.Rad",
          tanggalBaca: "5 Mei 2026, 09:00",
        },
        {
          modalitas: "USG",
          temuan:
            "LV: dilatasi sedang (LVEDD 62 mm), hipokinesis global. EF 28% (Simpson biplane). LA: dilatasi sedang (LAD 46 mm). Katup: MR sedang (regurgitasi jet ke LA), TR ringan. IVC: dilatasi (20 mm), kolapsibilitas < 50% — kesan tekanan vena sentral meningkat. Perikardium: efusi minimal.",
          kesan:
            "Disfungsi sistolik LV berat (EF 28%), dilatasi LV dan LA. MR sedang. Peningkatan tekanan pengisian LV konsisten dengan GJK dekompensata.",
          radiolog: "dr. Kartika, Sp.JP (Ekokardiografi)",
          tanggalBaca: "5 Mei 2026, 11:30",
        },
      ],
    },
    {
      id: "rr-ri-2",
      noOrder: "RAD/2026/03/0188",
      ...
      status: "Selesai",
      items: [
        { id: "rri-ri-3", kode: "RAD-XR001", nama: "Foto Thorax PA", modalitas: "X-Ray", waktuTunggu: "30–60 mnt" },
      ],
      hasil: [
        {
          modalitas: "X-Ray",
          proyeksi: "PA",
          temuan:
            "Jantung: CTR ± 0.60, pembesaran LV dan LA. Aorta: elongasi ringan. Paru: corakan vaskular meningkat, tidak tampak infiltrat aktif. Sinus kostofrenikus bilateral tajam.",
          kesan:
            "Kardiomegali dengan pembesaran LV dan LA. Tidak tampak tanda bendungan paru aktif saat ini.",
          radiolog: "dr. Purnomo, Sp.Rad",
          tanggalBaca: "20 Mar 2026, 11:45",
        },
      ],
    },
  ],
