  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xs">
        ...
        >
          {/* Avatar — absolute, straddles banner/content border */}
          ...
          <div className="mt-3 grid grid-cols-3 gap-2">
            ...
            <div className="rounded-xl bg-sky-50 p-2.5 text-center">
              <p className="text-base font-black text-sky-700">
                {
                  patient.riwayatKunjungan.filter((k) => k.status === "Aktif")
                    .length
                }
              </p>
            ...
            >
              <p
                className={cn(
                  ...
                  upcomingCount > 0 ? "text-emerald-700" : "text-slate-400",
                )}
              >
                {upcomingCount}
              </p>
              <p
                className={cn(
                  ...
                  upcomingCount > 0 ? "text-emerald-400" : "text-slate-400",
                )}
              >
                Jadwal
              </p>
