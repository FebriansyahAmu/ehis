...
import {
  type LayananMap,
  countAllLayanan, unitsFromTree, mapFromEdges, edgeKey, setPresence,
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-0.5 m-tiny text-slate-500">
            Atur obat apa masuk formularium (boleh diresepkan) di unit mana — berlaku universal
            (BPJS/Umum sama). Baris dari Katalog Obat; kolom dari Ruangan (Location) aktif. Klik judul
            kolom = toggle semua obat; klik judul baris = toggle semua unit.
          </p>
        </div>
