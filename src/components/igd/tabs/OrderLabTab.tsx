              ...
              {hasil.map((h, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className={cn("px-4 py-2.5 text-right font-bold tabular-nums", cls.val)}>
                      {h.nilai}
                    </td>
                    <td className="px-4 py-2.5 text-slate-500">{h.satuan}</td>
                    <td className="px-4 py-2.5 text-slate-400">{h.nilaiNormal}</td>
                    <td className="px-4 py-2.5">
                      <span className={cn("rounded-md px-2 py-0.5 text-[10px] font-medium", cls.badge)}>
                        {h.status}
                      </span>
                    </td>
                  </tr>
...
function RiwayatLabSection({ riwayat }: { riwayat: RiwayatOrder[] }) {
  ...
  return (
    <>
      {modalOrder && (
        <HasilModal order={modalOrder} onClose={() => setModalOrder(null)} />
      )}
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <div className="flex flex-col gap-3">
              <div>
                ...
                <p className="mt-1.5 text-[10px] text-slate-400">Ketik minimal 2 karakter · pemeriksaan yang sudah ditambah tidak muncul kembali</p>
              </div>
