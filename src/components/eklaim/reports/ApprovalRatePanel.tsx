  ...
  return (
    <div className="p-5 space-y-5">
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <h2 className="text-sm font-semibold text-slate-800">Tren Approval Rate</h2>
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="ml-auto flex items-center gap-1.5 rounded-lg bg-slate-50 px-3 py-2">
          ...
          <span className={`text-xs font-semibold tabular-nums ${overallDelta >= 0 ? "text-emerald-700" : "text-rose-600"}`}>
          ...
          {reasons.map((r, idx) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1 space-y-1">
                <p className="truncate text-xs text-slate-700">{r.reason}</p>
                <div className="flex items-center gap-2">
              ...
              <span className="w-8 shrink-0 text-right text-xs font-semibold text-rose-600 tabular-nums">
                {r.count}
              </span>
            </motion.div>
          ))}
