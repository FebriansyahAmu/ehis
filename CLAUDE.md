...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 ✅ · EK1 ✅ · EK2 ✅ · EK3 ✅ · EK4 ✅ · EK5 ✅ 100%** — EK5 Berkas Generator: 3 A4 template (ResumeMedis + BerkasKlaim cover + SuratPengantar) · KopSuratEklaim · BerkasGeneratorModal (3-card selector + zoom:0.52 preview + print CSS visibility + bundle download JSON) · wired ke ClaimBannerHeader "Generate" button. 66+ file total. **iDRG-first** (7-digit · ICD-10-IM · KRIS · Pedoman iDRG 2025 + Perpres 59/2024). Next: EK6 Banding Board. Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
