...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 ✅ · EK1 ✅ · EK2 ✅ · EK3 ✅ 100%** — EK3.7 Modals: **UploadBerkasModal** (2-panel kategori+dropzone) · **EditKodingModal** (ICD-10/9-IM inline search · ICS v1 validation · coder signature) · **SubmitBatchModal** (checklist 4-item · batch picker · V-Claim submit mock) · wired ke ClaimBannerHeader (+Edit Koding+Upload buttons) + KlaimDetailPage · modalShared.ts (BACKDROP_V/PANEL_V/ITEM_V/hooks). 55+ file total. **iDRG-first** (7-digit · ICD-10-IM · KRIS · Pedoman iDRG 2025 + Perpres 59/2024). Next: EK4 iDRG Calculator standalone. Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
...
- [🚧] **`ehis-eklaim`** Klaim — modul baru hasil scope-split dari billing (workflow batch + persona Tim Klaim/Coder berbeda). **Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md)** (39 task, fase EK0–EK9 · ~11/39 = 28%). **EK0 ✅ · EK1 ✅ · EK2 ✅ · EK3 ✅ 100% (EK3.1–EK3.7 semuanya done)**. EK3.7 Modals: UploadBerkasModal · EditKodingModal · SubmitBatchModal · wired ke banner. Next: EK4 iDRG Calculator standalone (2 hari).
