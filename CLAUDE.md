...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 Foundation 100% · EK1 Beranda 100%** (Hero · KPI Strip 5-card teal/amber/rose/emerald/sky · Quick-Nav 2x2 · 3 sidebar panel Butuh Banding/Akan Expired/Recent Submission). 22 file total · ~6520 ln. **iDRG-first** (kode 7-digit · ICD-10-IM · KRIS · tingkat kompetensi RS sesuai Pedoman iDRG 2025 + Perpres 59/2024). INA-CBG legacy adapter siap (parked). Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
