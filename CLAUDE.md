...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 ✅ · EK1 ✅ · EK2 ✅ · EK3 ✅ · EK4 ✅ · EK5 ✅ · EK6.1+EK6.2 ✅** — EK6 Banding: `BandingBoardPage` 2-panel (filter 260px + table) · `BandingKPIStrip` 3 cards adaptive · `BandingTable` quick-tabs + stagger rows · `BandingFilterPanel` (search/periode/penjamin/tingkat/status) · `BandingFormModal` 2-panel (klaim context kiri + form kanan: tingkat toggle + alasan min 50 char + file upload stub + validation) · 8 mock entries · wired "Ajukan Banding" di ClaimBannerHeader (Rejected). 76+ file total. **iDRG-first**. Next: EK6.3 Banding Detail. Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
...
- [🚧] **`ehis-eklaim`** Klaim — modul baru hasil scope-split dari billing (workflow batch + persona Tim Klaim/Coder berbeda). **Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md)** (39 task, fase EK0–EK9 · ~13/39 = 33%). **EK0 ✅ · EK1 ✅ · EK2 ✅ · EK3 ✅ · EK4 ✅ 100%**. EK4 Calculator: mode toggle (iDRG/Legacy/Compare) · 2-col form · 4 Tingkat RS tiles · iDRG/INA-CBG result · Compare + DeltaChip + MarginBar · resolveComparator wired · TSC clean. Next: EK5 Berkas Generator PDF Templates.
