...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 ✅ · EK1 ✅ · EK2 ✅ · EK3 ✅ · EK4 ✅ 100%** — EK4 iDRG Calculator: mode toggle (iDRG/INA-CBG Legacy/Compare Both) · 2-col (ICD picker left + params right) · 4 colorful Tingkat RS tiles · iDRG 7-digit result + severity · INA-CBG tarif kelas · Compare side-by-side + DeltaChip + MarginBar · `resolveGrouping`/`resolveComparator` wired · TSC clean. 60+ file total. **iDRG-first** (7-digit · ICD-10-IM · KRIS · Pedoman iDRG 2025 + Perpres 59/2024). Next: EK5 Berkas Generator. Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
