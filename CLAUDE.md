...
| `/ehis-billing`            | Billing Kasir    | 🚧 BL1 ✅ + BL2.1-2.4 ✅ — Tagihan board + Invoice detail (Rincian+Pembayaran+Klaim-lite). Roadmap [TODO-BILLING.md](TODO-BILLING.md) |
...
- [🚧] **`ehis-billing`** Kasir — invoice per kunjungan + rincian + pembayaran + print struk. **Roadmap [TODO-BILLING.md](TODO-BILLING.md)** (35 task, fase BL0–BL9). BL1 ✅ + BL2.1-2.4 ✅. Next: BL2.5 Riwayat Audit · BL2.6 Print Preview · atau BL0 Foundation.
