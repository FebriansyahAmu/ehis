...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 Foundation 100% · EK1 Beranda 100% · EK2.1 Klaim Board Layout & Filter 100% · EK2.3 Logic ~90%** (Hero teal slim · KPI Strip 4-card dinamis aware ke filter · FilterPanel 300px sticky 8-section [search · periode · penjamin tipe/nama · era grouper · unit · kelas · status 13 chip] + hidden scrollbar · Quick Tabs 5 dengan count after-filter aware · Density toggle · Preview placeholder 6 row sambil menunggu EK2.2 Tabel + Bulk Action). 30 file total. **iDRG-first** (kode 7-digit · ICD-10-IM · KRIS · tingkat kompetensi RS sesuai Pedoman iDRG 2025 + Perpres 59/2024). INA-CBG legacy adapter siap (parked). Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
