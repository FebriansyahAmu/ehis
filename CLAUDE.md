...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 Foundation 100%** (Types · Mocks · Helpers · Adapters · 15 file · ~5150 ln di `src/lib/eklaim/`). UI belum dimulai (EK1-EK9). **iDRG-first** (kode 7-digit · ICD-10-IM · KRIS · tingkat kompetensi RS sesuai Pedoman iDRG 2025 + Perpres 59/2024). INA-CBG legacy adapter siap (parked). Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
