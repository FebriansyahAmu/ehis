...
| `/ehis-eklaim`             | E-Klaim          | 🚧 **EK0 Foundation 100% · EK1 Beranda 100% · EK2 Klaim Board 100%** (EK2.1 Layout: Hero teal · KPI Strip 4-card dinamis · FilterPanel 300px sticky 8-section · Quick Tabs 5 dengan count after-filter aware · Density toggle. **EK2.2 Tabel: Sticky-header 11 kolom · sort 3-state 7 kolom · select-all indeterminate · Kebab 9-aksi disabledIf · row click navigate · footer summary 3 total · empty state teal**. **EK2.3 Logic: applyFilters/applySort/cycleSort/computeQuickTabCounts/computeKPIs/canBulkSubmit/canBulkCekEligibility/kebabActionsFor/exportKlaimCsv (RFC 4180)**. **EK2 Bulk Bar sky slide-up: Submit/Eligibility/Berkas/Export CSV**). 35 file total. **iDRG-first** (kode 7-digit · ICD-10-IM · KRIS · tingkat kompetensi RS sesuai Pedoman iDRG 2025 + Perpres 59/2024). INA-CBG legacy adapter siap (parked). Next: EK3 Klaim Detail (6-tab workspace · 5-6 hari). Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md) |
...
- [🚧] **`ehis-eklaim`** Klaim — modul baru hasil scope-split dari billing (workflow batch + persona Tim Klaim/Coder berbeda). **Roadmap [TODO-EKLAIM.md](TODO-EKLAIM.md)** (39 task, fase EK0–EK9 · 7/39 = 18%). **EK0 Foundation 100% · EK1 Beranda 100%**. Next: EK2 Klaim Board (3-4 hari · worklist cross-invoice dengan filter + bulk action) atau EK3 Klaim Detail (5-6 hari · 6-tab workspace).
