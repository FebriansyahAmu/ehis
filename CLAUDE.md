...
| [docs/BACKEND-MASTER-KATALOG-KLINIS.md](docs/BACKEND-MASTER-KATALOG-KLINIS.md) | **Backend grup Katalog Klinis** — Tindakan ✅ · ICD ✅ · Obat/Lab/Rad/SDKI 📋. |
| [docs/BACKEND-MAPPING.md](docs/BACKEND-MAPPING.md) | **Backend Mapping Hub** (`/ehis-master/mapping`) — status per sub-pane: SDM ✅ · Layanan Unit ✅ · RBAC ✅ · Tarif ✅ · Kewenangan 🟡 · Formularium/Distribusi/Penjamin 📋. |
